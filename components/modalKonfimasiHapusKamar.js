...
const ModalKonfirmasiHapusKamar = ({
  terbuka,
  tertutup,
  kamarYangTerpilih,
  konfirmasiHapusKamar,
  sedangMemuatHapus,
}) => {
  return (
    <Dialog
    ...
    >
      ...
      <DialogHeader className="text-black">
        Konfirmasi Hapus Data Kamar
      </DialogHeader>
      <DialogBody className="text-black">
        <p>
          Apakah Anda yakin ingin menghapus kamar{" "}
          <strong className="font-bold">{kamarYangTerpilih}</strong>? Tindakan
      ...
      <DialogFooter className="space-x-4">
        ...
        >
          {sedangMemuatHapus ? <Memuat /> : "Hapus Kamar"}{" "}
        </Button>
      </DialogFooter>
    </Dialog>
  );
...
export default ModalKonfirmasiHapusKamar;
